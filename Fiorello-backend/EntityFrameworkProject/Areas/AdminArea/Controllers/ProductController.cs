...
namespace EntityFrameworkProject.Areas.AdminArea.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Update(int id, ProductUpdateVM productUpdate)
        {
            Product product = await _context.Products
                    .Where(m => !m.IsDeleted)
                    .Include(m => m.ProductImages)
            ...
            ProductUpdateVM productUpdateVm = new ProductUpdateVM
            {
                Title = productUpdateVM.Title,
                Description = productUpdateVM.Description,
                Price = productUpdateVM.Price,
